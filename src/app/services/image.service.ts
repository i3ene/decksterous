...
export class ImageService {
  ...
  upload(e: any, source: any): void {
    ...
    reader.onload = (re: ProgressEvent<FileReader>) => this._handleLoaded(re, source);
    reader.readAsDataURL(file);
  }

  _handleLoaded(e: ProgressEvent<FileReader>, source: any): void {
    ...
    if (!reader?.result) {
      ...
      this._compress(source, reader.result);
    }
  }

  _compress(source: any, data: string): any {
